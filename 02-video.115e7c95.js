 ...
 * @module lib/embed
 */var z=["autopause","autoplay","background","byline","color","colors","controls","dnt","height","id","interactive_params","keyboard","loop","maxheight","maxwidth","muted","playsinline","portrait","responsive","speed","texttrack","title","transparent","url","width"];/**
 * Get the 'data-vimeo'-prefixed attributes from an element as an object.
 *
 * @param {HTMLElement} element The element.
 * @param {Object} [defaults={}] The default values to use.
 * @return {Object<string, string>}
 */function G(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return z.reduce(function(t,n){var r=e.getAttribute("data-vimeo-".concat(n));return(r||""===r)&&(t[n]=""===r?1:r),t},t)}/**
 ...
 */var $={role:"viewer",autoPlayMuted:!0,allowedDrift:.3,maxAllowedDrift:1,minCheckInterval:.1,maxRateAdjustment:.2,maxTimeToCatchUp:1},Q=/*#__PURE__*/function(e){!function(e,t){if("function"!=typeof t&&null!==t)throw TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),Object.defineProperty(e,"prototype",{writable:!1}),t&&k(e,t)}(a,e);var t,n,r,o,i=(t=E(),function(){var e,n=w(a);if(t){var r=w(this).constructor;e=Reflect.construct(n,arguments,r)}else e=n.apply(this,arguments);return function(e,t){if(t&&("object"==typeof t||"function"==typeof t))return t;if(void 0!==t)throw TypeError("Derived constructors may only return object or undefined");return P(e)}(this,e)});/**
...
}})}(r,o)}},r._window.addEventListener("message",r._onMessage),"IFRAME"!==r.element.nodeName){var i=G(e,o);Y(N(i),i,e).then(function(t){var n,o,i=H(t,e);return(// Overwrite element with the new iframe,
...
J.set(this,a),B.set(this.element,this),"IFRAME"===this.element.nodeName&&U(this,"ping"),K.isEnabled){var u=function(){return K.exit()};this.fullscreenchangeHandler=function(){K.isFullscreen?q(r,"event:exitFullscreen",u):D(r,"event:exitFullscreen",u),// eslint-disable-next-line
...
return t.ready().then(function(){q(t,e,{resolve:r,reject:o}),U(t,e,n)}).catch(o)})}},{key:"get",value:function(e){var t=this;return new R(function(n,r){// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
return e=_(e,"get"),t.ready().then(function(){q(t,e,{resolve:n,reject:r}),U(t,e)}).catch(r)})}},{key:"set",value:function(e,t){var n=this;return new R(function(r,o){if(e=_(e,"set"),null==t)throw TypeError("There must be a value to set.");// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
return n.ready().then(function(){q(n,e,{resolve:r,reject:o}),U(n,e,t)}).catch(o)})}},{key:"on",value:function(e,t){if(!e)throw TypeError("You must pass an event name.");if(!t)throw TypeError("You must pass a callback function.");if("function"!=typeof t)throw TypeError("The callback must be a function.");0===V(this,"event:".concat(e)).length&&this.callMethod("addEventListener",e).catch(function(){// Ignore the error. There will be an error event fired that
...
if(null!==e.getAttribute("data-vimeo-defer"))return;var t=G(e),r=N(t);Y(r,t,e).then(function(t){return H(t,e)}).catch(n)}catch(e){n(e)}})}(),/**
