...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ef(t)||0,es(n)&&(s=!!n.leading,i=(f="maxWait"in n)?eu(ef(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(el())},m}(e,t,{leading:r,maxWait:t,trailing:o})};let ed=document.querySelector("iframe"),eh=(e=>{try{let t=localStorage.getItem(e);return null===t?void 0:JSON.parse(t)}catch(e){console.error("Get state error: ",e.message)}})("videoplayer-current-time"),ep=B(function(e){((e,t)=>{try{let n=JSON.stringify(t);localStorage.setItem(e,n)}catch(e){console.error("Set state error: ",e.message)}})("videoplayer-current-time",e.seconds)},1500),ev=new Q(ed);ev.on("timeupdate",ep),ev.setCurrentTime(eh)}();//# sourceMappingURL=02-video.0be15744.js.map

//# sourceMappingURL=02-video.0be15744.js.map
