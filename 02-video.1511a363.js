 ...
 * @return {string}
 */function T(e,t){return 0===e.indexOf(t.toLowerCase())?e:"".concat(t.toLowerCase()).concat(e.substr(0,1).toUpperCase()).concat(e.substr(1))}/**
 * Check to see if the URL is a Vimeo url.
 *
 * @param {string} url The url string.
 * @return {boolean}
 */function P(e){return/^(https?:)?\/\/((player|www)\.)?vimeo\.com(?=$|\/)/.test(e)}/**
...
if("IFRAME"===e.nodeName&&!P(e.getAttribute("src")||""))throw Error("The player element passed isn’t a Vimeo embed.");// If there is already a player object in the map, return that
if(H.has(e))return H.get(e);this._window=e.ownerDocument.defaultView,this.element=e,this.origin="*";var a=new C(function(t,n){if(r._onMessage=function(e){if(P(e.origin)&&r.element.contentWindow===e.source){"*"===r.origin&&(r.origin=e.origin);var o=I(e.data);if(o&&"error"===o.event&&o.data&&"ready"===o.data.method){var i=Error(o.data.message);i.name=o.data.name,n(i);return}var a=o&&"ready"===o.event,u=o&&"ping"===o.method;if(a||u){r.element.setAttribute("data-ready","true"),t();return}!/**
...
// can’t return here.
// eslint-disable-next-line promise/always-return
return e=T(e,"get"),t.ready().then(function(){L(t,e,{resolve:n,reject:r}),q(t,e)}).catch(r)})}},{key:"set",value:function(e,t){var n=this;return new C(function(r,o){if(e=T(e,"set"),null==t)throw TypeError("There must be a value to set.");// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ef(t)||0,es(n)&&(s=!!n.leading,i=(f="maxWait"in n)?eu(ef(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(el())},m}(e,t,{leading:r,maxWait:t,trailing:o})};const ed=document.querySelector("iframe"),eh=(e=>{try{let t=localStorage.getItem(e);return null===t?void 0:JSON.parse(t)}catch(e){console.error("Get state error: ",e.message)}})("videoplayer-current-time"),ep=B(function(e){((e,t)=>{try{let n=JSON.stringify(t);localStorage.setItem(e,n)}catch(e){console.error("Set state error: ",e.message)}})("videoplayer-current-time",e.seconds)}//# sourceMappingURL=02-video.1511a363.js.map
,1500),ev=new Q(ed);ev.on("timeupdate",ep),ev.setCurrentTime(eh);
//# sourceMappingURL=02-video.1511a363.js.map
